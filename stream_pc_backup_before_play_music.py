...
class TTSClient:
    ...
    def synthesize(self, text: str, voice: Optional[str] = None, speed: Optional[float] = 1.0) -> Optional[requests.Response]:
        ...
        while True:
            ...
            try:
                if cmd == "speak" and text:
                    ...
                    response = self.tts_client.synthesize(text, voice, speed)
                    ...
                    self.audio_player.play_wav_file('./bgm_wav/'+text+'.wav')
